...
#ifdef TARGET_OS2
static long snd_gf1_port[SNDRV_CARDS] = {-1,-1,-1,-1,-1,-1,-1,-1}; /* 0x210,0x220,0x230,0x240,0x250,0x260,0x270 */
static long snd_mpu_port[SNDRV_CARDS] = {-1,-1,-1,-1,-1,-1,-1,-1}; /* 0x300,0x310,0x320 */
#else

...
#ifdef TARGET_OS2
static long gf1_port[SNDRV_CARDS] = {-1,-1,-1,-1,-1,-1,-1,-1}; /* 0x210,0x220,0x230,0x240,0x250,0x260,0x270 */
static long mpu_port[SNDRV_CARDS] = {-1,-1,-1,-1,-1,-1,-1,-1}; /* 0x300,0x310,0x320 */
#else
...
#ifdef TARGET_OS2
static int joystick_dac[SNDRV_CARDS] = {REPEAT_SNDRV(29)};
				/* 0 to 31, (0.59V-4.52V or 0.389V-2.98V) */
static int channels[SNDRV_CARDS] = {REPEAT_SNDRV(24)};
static int pcm_channels[SNDRV_CARDS] = {REPEAT_SNDRV(2)};
#else

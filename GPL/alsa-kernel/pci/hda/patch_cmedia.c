...
static struct hda_pcm_stream cmi9880_pcm_analog_playback = {
	...
	/*.channels_max = */8,
        ...
        0,0,0,
	/*.ops = */{
		/*.open = */cmi9880_playback_pcm_open,0,
...
static struct hda_pcm_stream cmi9880_pcm_digital_playback = {
	...
	/*.ops = */{
		...
		/*.close = */cmi9880_dig_playback_pcm_close,0,0
	},
};
...
static struct hda_board_config cmi9880_cfg_tbl[] = {
	{ "minimal", CMI_MINIMAL, 0, 0 },
	{ "min_fp",  CMI_MIN_FP, 0, 0 },
	{ "full",    CMI_FULL, 0, 0 },
	{ "full_dig",CMI_FULL_DIG, 0, 0 },
        { "allout",  CMI_ALLOUT, 0, 0 },
        { "auto",    CMI_AUTO, 0, 0 },
	{0} /* terminator */
};
...
struct hda_codec_preset snd_hda_preset_cmedia[] = {
    { 0x13f69880, 0,0,0,0,"CMI9880", patch_cmi9880 },
    { 0x434d4980, 0,0,0,0,"CMI9880", patch_cmi9880 },
    {0} /* terminator */
};

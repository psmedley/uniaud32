...
static struct hda_pcm_stream ad198x_pcm_analog_playback = {
    ...
    0,0,0,
    /*.ops = */{
        /*.open = */ad198x_playback_pcm_open, 0,
...
static snd_kcontrol_new_t ad1986a_mixers[] = {
    {
        ...
        /*.name = */"PCM Playback Volume",0,0,0,
    ...
    {
        /*.iface = */SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
        /*.name = */"PCM Playback Switch",0,0,0,
...
static snd_kcontrol_new_t ad1983_mixers[] = {
	...
	{
		/*.iface = */SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
		/*.name = */"IEC958 Playback Route",0,0,0,
		/*.info = */ad1983_spdif_route_info,
		/*.get = */ad1983_spdif_route_get,
		/*.put = */ad1983_spdif_route_put,0
	},
	{0} /* end */
};
...
struct hda_codec_preset snd_hda_preset_analog[] = {
    { /*.id = */0x11d41981, 0, 0, 0, 0,/*.name = */"AD1981", /*.patch = */patch_ad1981 },
    { /*.id = */0x11d41983, 0, 0, 0, 0,/*.name = */"AD1983", /*.patch = */patch_ad1983 },

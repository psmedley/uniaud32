...
static struct hda_pcm_stream stac92xx_pcm_analog_playback = {
	...
	/*.channels_max = */2,
        ...
        0,0,0,
	/*.ops = */{
		/*.open = */stac92xx_playback_pcm_open, 0,
...
struct hda_codec_preset snd_hda_preset_sigmatel[] = {
 	{ /*.id = */0x83847690, 0, 0, 0, 0,/*.name = */"STAC9200",    /*.patch = */patch_stac9200 },
 	{ /*.id = */0x83847882, 0, 0, 0, 0,/*.name = */"STAC9220 A1", /*.patch = */patch_stac922x },
 	{ /*.id = */0x83847680, 0, 0, 0, 0,/*.name = */"STAC9221 A1", /*.patch = */patch_stac922x },
 	{ /*.id = */0x83847880, 0, 0, 0, 0,/*.name = */"STAC9220 A2", /*.patch = */patch_stac922x },
 	{ /*.id = */0x83847681, 0, 0, 0, 0,/*.name = */"STAC9220D/9223D A2", /*.patch = */patch_stac922x },
 	{ /*.id = */0x83847682, 0, 0, 0, 0,/*.name = */"STAC9221 A2", /*.patch = */patch_stac922x },
 	{ /*.id = */0x83847683, 0, 0, 0, 0,/*.name = */"STAC9221D A2", /*.patch = */patch_stac922x },
	{0} /* terminator */
};

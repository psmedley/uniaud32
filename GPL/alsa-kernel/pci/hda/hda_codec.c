		    ...
		    struct hda_bus **busp)
{
	...
	static snd_device_ops_t dev_ops = {
		/*.dev_free = */snd_hda_bus_dev_free,0,0,0
	};
...
static snd_kcontrol_new_t dig_mixes[] = {
	{
		...
		/*.name = */SNDRV_CTL_NAME_IEC958("",PLAYBACK,CON_MASK),0,
		/*.access = */SNDRV_CTL_ELEM_ACCESS_READ,0,
		/*.info = */snd_hda_spdif_mask_info,
		/*.get = */snd_hda_spdif_cmask_get,0,0
	},
	{
		/*.iface = */SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
		/*.name = */SNDRV_CTL_NAME_IEC958("",PLAYBACK,PRO_MASK),0,
		/*.access = */SNDRV_CTL_ELEM_ACCESS_READ,0,
		/*.info = */snd_hda_spdif_mask_info,
		/*.get = */snd_hda_spdif_pmask_get,0,0
	},
	{
		/*.iface = */SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
		...
		/*.put = */snd_hda_spdif_default_put,0
	},
	{
		/*.iface = */SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
		/*.name = */SNDRV_CTL_NAME_IEC958("",PLAYBACK,SWITCH),0,0,0,
		/*.info = */snd_hda_spdif_out_switch_info,
		/*.get = */snd_hda_spdif_out_switch_get,
		/*.put = */snd_hda_spdif_out_switch_put,0
	},
	{0} /* end */
};
...
static snd_kcontrol_new_t dig_in_ctls[] = {
    {
        ...
        SNDRV_CTL_NAME_IEC958("",CAPTURE,SWITCH),0,0,0,
        snd_hda_spdif_in_switch_info,
        snd_hda_spdif_in_switch_get,
        snd_hda_spdif_in_switch_put,0
    },
    {
        SNDRV_CTL_ELEM_IFACE_MIXER,0,0,
        SNDRV_CTL_NAME_IEC958("",CAPTURE,DEFAULT),0,
        SNDRV_CTL_ELEM_ACCESS_READ,0,
        snd_hda_spdif_mask_info,
        snd_hda_spdif_in_status_get,0,0
    },
    {0} /* end */
};

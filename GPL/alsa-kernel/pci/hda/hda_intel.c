...
#define azx_writel(chip,reg,value) \
	writel(value, (char*)(chip)->remap_addr + ICH6_REG_##reg)
#define azx_readl(chip,reg) \
	readl((char*)(chip)->remap_addr + ICH6_REG_##reg)
#define azx_writew(chip,reg,value) \
	writew(value, (char*)(chip)->remap_addr + ICH6_REG_##reg)
#define azx_readw(chip,reg) \
	readw((char*)(chip)->remap_addr + ICH6_REG_##reg)
#define azx_writeb(chip,reg,value) \
	writeb(value, (char*)(chip)->remap_addr + ICH6_REG_##reg)
#define azx_readb(chip,reg) \
	readb((char*)(chip)->remap_addr + ICH6_REG_##reg)

#define azx_sd_writel(dev,reg,value) \
	writel(value, (char*)(dev)->sd_addr + ICH6_REG_##reg)
#define azx_sd_readl(dev,reg) \
	readl((char*)(dev)->sd_addr + ICH6_REG_##reg)
#define azx_sd_writew(dev,reg,value) \
	writew(value, (char*)(dev)->sd_addr + ICH6_REG_##reg)
#define azx_sd_readw(dev,reg) \
	readw((char*)(dev)->sd_addr + ICH6_REG_##reg)
#define azx_sd_writeb(dev,reg,value) \
	writeb(value, (char*)(dev)->sd_addr + ICH6_REG_##reg)
#define azx_sd_readb(dev,reg) \
	readb((char*)(dev)->sd_addr + ICH6_REG_##reg)
...
static snd_pcm_ops_t azx_pcm_ops = {
	...
	/*.pointer = */azx_pcm_pointer,0,0,0,0
};
...
static int __devinit azx_init_stream(azx_t *chip)
{
	...
	for (i = 0; i < MAX_ICH6_DEV; i++) {
		...
		azx_dev->sd_addr = (char*)chip->remap_addr + (0x20 * i + 0x80);

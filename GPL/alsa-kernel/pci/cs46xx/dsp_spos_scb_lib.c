	                       ...
	                       int pass_through)
{
...

	{
		src_task_scb_t src_task_scb = {
			...
			0x0000,/*src_delay_buffer_addr*/0,
			0x0,                                            
			0x080,/*(src_delay_buffer_addr + (24 * 4))*/0,
                                    ...
                                    int scb_child_type)
{
	...
	vari_decimate_scb_t vari_decimate_scb = {
		...
		0xFF800000,   
		0,
		0x0080,/*vari_buffer_addr1 + (25 * 4)*/0,
                                   ...
                                   int scb_child_type)
{
	...
	asynch_fg_tx_scb_t asynch_fg_tx_scb = {
		...
		0,/*hfg_scb_address*/0,  /* Point to HFG task SCB */

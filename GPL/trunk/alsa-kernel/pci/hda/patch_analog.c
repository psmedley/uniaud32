...
#ifdef TARGET_OS2
#define KBUILD_MODNAME "patch_analog"
#endif
...
#ifdef TARGET_OS2
static const struct hda_pintbl AD1986A_FIXUP_ULTRA_PINS[] = {
			{ 0x1b, 0x90170110 }, /* speaker */
			{ 0x1d, 0x90a7013e }, /* int mic */
			{0}
		};

static const struct hda_pintbl AD1986A_FIXUP_SAMSUNG_PINS[] = {
			{ 0x1b, 0x90170110 }, /* speaker */
			{ 0x1d, 0x90a7013e }, /* int mic */
			{ 0x20, 0x411111f0 }, /* N/A */
			{ 0x24, 0x411111f0 }, /* N/A */
...
static const struct hda_pintbl AD1986A_FIXUP_3STACK_PINS[] = {
...
static const struct hda_pintbl AD1986A_FIXUP_LAPTOP_PINS[] = {
			{ 0x1a, 0x02214021 }, /* headphone */
			{ 0x1b, 0x90170110 }, /* speaker */
			{ 0x1c, 0x411111f0 }, /* N/A */
			{ 0x1d, 0x411111f0 }, /* N/A */
...
static const struct hda_pintbl AD1986A_FIXUP_LAPTOP_IMIC_PINS[] = {
			{ 0x1d, 0x90a7013e }, /* int mic */
			{0}
		};
...
#else
		.v.pins = AD1986A_FIXUP_ULTRA_PINS,
#endif
	},
	[AD1986A_FIXUP_SAMSUNG] = {
		.type = HDA_FIXUP_PINS,
...
#else
		.v.pins = AD1986A_FIXUP_SAMSUNG_PINS,
#endif
	},
	[AD1986A_FIXUP_3STACK] = {
		.type = HDA_FIXUP_PINS,
...
#else
		.v.pins = AD1986A_FIXUP_3STACK_PINS,
#endif
	},
	[AD1986A_FIXUP_LAPTOP] = {
		.type = HDA_FIXUP_PINS,
...
#else
		.v.pins = AD1986A_FIXUP_LAPTOP_PINS,
#endif
	},
	[AD1986A_FIXUP_LAPTOP_IMIC] = {
		.type = HDA_FIXUP_PINS,
...
#else
		.v.pins = AD1986A_FIXUP_LAPTOP_IMIC_PINS,
#endif
		.chained_before = 1,
...
#ifdef TARGET_OS2
static const struct hda_pintbl AD1988_FIXUP_6STACK_DIG_pins[] = {
...
#else
		.v.pins = AD1988_FIXUP_6STACK_DIG_pins,
#endif
	},
};

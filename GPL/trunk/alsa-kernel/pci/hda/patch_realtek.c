...
#ifdef TARGET_OS2
static const struct alc_pincfg alc260_pins[] = {
...
static const struct alc_fixup alc260_fixups[] = {
	[PINFIX_HP_DC5750] = {
		.type = ALC_FIXUP_PINS,
#ifndef TARGET_OS2 /* fails to compile with Watcom */
...
#ifdef TARGET_OS2
static const struct alc_pincfg alc882_fixup_abit_aw9d_max_pins[] = {
...
static const struct hda_verb alc882_verbs_pb_m5210[] = {
			{ 0x19, AC_VERB_SET_PIN_WIDGET_CONTROL, PIN_VREF50 },
			{0}
};
#endif
...
#ifdef TARGET_OS2
static const struct alc_pincfg alc262_pins[] = {
...
#ifdef TARGET_OS2
static const struct hda_verb alc269_fixup_sony_viao_verbs[] = {
			{0x19, AC_VERB_SET_PIN_WIDGET_CONTROL, PIN_VREFGRD},
			{0}
};

static const struct hda_verb alc275_fixup_sony_viao_gpio2_verbs[] = {
...
#else
		.v.verbs = alc269_fixup_sony_viao_verbs,
#endif
	},
	[ALC275_FIXUP_SONY_VAIO_GPIO2] = {
		.type = ALC_FIXUP_VERBS,
...
#else
		.v.verbs = alc275_fixup_sony_viao_gpio2_verbs,
#endif
		.chained = true,

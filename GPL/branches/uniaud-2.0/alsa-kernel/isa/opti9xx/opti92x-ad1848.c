...
{ SNDRV_CTL_ELEM_IFACE_MIXER, 0, 0, xname, xindex, \
  0, 0, snd_opti93x_info_single, \
  snd_opti93x_get_single, snd_opti93x_put_single, \
...
{ SNDRV_CTL_ELEM_IFACE_MIXER, 0, 0, xname, xindex, \
  0, 0, snd_opti93x_info_double, \
  snd_opti93x_get_double, snd_opti93x_put_double, \

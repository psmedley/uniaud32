...
static void update_outputs(struct hda_codec *codec)
{
	...
	do_automute(codec, ARRAY_SIZE(spec->autocfg.hp_pins),
		    spec->autocfg.hp_pins, (bool) spec->master_mute, true);
...
#ifdef TARGET_OS2
static const struct alc_pincfg alc260_PINFIX_HP_DC5750[] = {
...
#else
		.v.pins = alc260_PINFIX_HP_DC5750,
#endif
	},
};
...
#ifdef TARGET_OS2
static const struct alc_pincfg alc882_fixup_PINFIX_ABIT_AW9D_MAX[] = {
...
static const struct alc_pincfg alc882_fixup_PINFIX_LENOVO_Y530[] = {
			{ 0x15, 0x99130112 }, /* rear int speakers */
			{ 0x16, 0x99130111 }, /* subwoofer */
			{0}
		};
static const struct hda_verb alc882_verbs_PINFIX_PB_M5210[] = {
			{ 0x19, AC_VERB_SET_PIN_WIDGET_CONTROL, PIN_VREF50 },
			{0}
		};
static const struct alc_pincfg PINFIX_ASUS_W90V_pins[] = {
...
#else
		.v.pins = alc882_fixup_PINFIX_ABIT_AW9D_MAX,
#endif
...
#else
		.v.pins = alc882_fixup_PINFIX_LENOVO_Y530,
#endif
	},
	[PINFIX_PB_M5210] = {
...
#else
		.v.verbs = alc882_verbs_PINFIX_PB_M5210,
#endif
	},
	[PINFIX_ACER_ASPIRE_7736] = {
		.type = ALC_FIXUP_SKU,
...
#ifdef TARGET_OS2
static const struct alc_pincfg alc262_fixups_PINFIX_FSC_H270[] = {
...
static const struct alc_pincfg alc262_fixups_PINFIX_HP_Z200[] = {
...
static const struct alc_pincfg ALC269_FIXUP_ASUS_G73JW_pins[] = {
...
static const struct alc_pincfg ALC269_FIXUP_LIFEBOOK_pins[] = {
			{ 0x1a, 0x2101103f }, /* dock line-out */
			{ 0x1b, 0x23a11040 }, /* dock mic-in */
			{0}
}; 

static const struct alc_pincfg ALC269_FIXUP_AMIC_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
...
static const struct alc_pincfg ALC269_FIXUP_DMIC_pins [] = {
...
static const struct alc_pincfg ALC269VB_FIXUP_AMIC_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x18, 0x01a19c20 }, /* mic */
			{ 0x19, 0x99a3092f }, /* int-mic */
...
static const struct alc_pincfg ALC269_FIXUP_DMIC2_pins[] = {
			{ 0x12, 0x99a3092f }, /* int-mic */
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x18, 0x01a19c20 }, /* mic */
			{ 0x21, 0x0121401f }, /* HP out */
...
#else
		.v.verbs = ALC275_FIXUP_SONY_VAIO_GPIO2_verbs,
#endif
...
#else
		.v.pins = ALC269_FIXUP_DMIC2_pins,
#endif
	},
#ifndef TARGET_OS2
	[ALC269_FIXUP_LENOVO_DOCK] = {
...
#ifdef TARGET_OS2
static const struct alc_pincfg PINFIX_FSC_AMILO_PI1505_pins[] = {
			{ 0x0b, 0x0221101f }, /* HP */
...
#else
		.v.verbs = ALC660VD_FIX_ASUS_GPIO1_verbs,
#endif
	},
	[ALC861VD_FIX_DALLAS] = {
		.type = ALC_FIXUP_FUNC,
...
#ifdef TARGET_OS2
static const struct alc_pincfg ALC662_FIXUP_ASPIRE_pins[] = {
			{ 0x15, 0x99130112 }, /* subwoofer */
			{0}
};

static const struct alc_pincfg ALC662_FIXUP_IDEAPAD_pins[] = {
...
static const struct alc_pincfg 	ALC662_FIXUP_HP_RP5800_pins[] = {
			{ 0x14, 0x0221201f }, /* HP out */
			{0}
};

static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE1_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x18, 0x01a19c20 }, /* mic */
			{ 0x19, 0x99a3092f }, /* int-mic */
			{ 0x21, 0x0121401f }, /* HP out */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE2_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x18, 0x01a19820 }, /* mic */
			{ 0x19, 0x99a3092f }, /* int-mic */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE3_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x15, 0x0121441f }, /* HP */
			{ 0x18, 0x01a19840 }, /* mic */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE4_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE5_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x15, 0x0121441f }, /* HP */
			{ 0x16, 0x99130111 }, /* speaker */
			{ 0x18, 0x01a19840 }, /* mic */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE6_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
			{ 0x15, 0x01211420 }, /* HP2 */
			{ 0x18, 0x01a19840 }, /* mic */
			{ 0x19, 0x99a3094f }, /* int-mic */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE7_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
...
static const struct alc_pincfg 	ALC662_FIXUP_ASUS_MODE8_pins[] = {
			{ 0x14, 0x99130110 }, /* speaker */
...
static const struct hda_codec_preset snd_hda_preset_realtek[] = {
	...
	{ .id = 0x10ec0300, .name = "ALC300", .patch = patch_alc269 },

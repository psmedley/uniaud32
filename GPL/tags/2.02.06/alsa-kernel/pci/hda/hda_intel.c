...
static void azx_power_notify(struct hda_bus *bus)
{
  ...
  list_for_each_entry(c, &bus->codec_list, list, struct hda_codec) {
    if (c->power_on) {
      power_on = 1;
      break;
    }
...
static DEFINE_PCI_DEVICE_TABLE(azx_ids) = {
  ...
  { PCI_DEVICE(0x8086, 0x1e20), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x8c20), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x8d20), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x8d21), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x9c20), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x9c21), .driver_data = AZX_DRIVER_PCH },
 	{ PCI_DEVICE(0x8086, 0x9ca0), .driver_data = AZX_DRIVER_PCH },
  /* SCH */

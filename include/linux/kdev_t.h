/* $Id: kdev_t.h,v 1.1.1.1 2003/07/02 13:57:00 eleph Exp $ */
...
#define kdev_t_to_nr(dev) (unsigned int)(MAJOR(dev)<<8) | MINOR(dev)
#define to_kdev_t(dev)    (kdev_t)MKDEV((dev >> 8), (dev & 0xff))
